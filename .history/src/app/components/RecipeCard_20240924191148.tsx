...
export function RecipeCard({ recipe }: Props) {
  return (
    ...
    >
      ...
      />
      <div className="absolute bottom-0 w-full overflow-hidden text-ellipsis whitespace-nowrap bg-gradient-to-b from-black to-transparent p-4 pb-14 text-lg font-bold text-white">
        {recipe.title}
      </div>
