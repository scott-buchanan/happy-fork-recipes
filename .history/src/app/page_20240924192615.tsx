      ...
      {randopes.recipes && (
        <>
          <p>
            ...
            fresh new favorites, we&apos;re here to help you whip up something amazing. So roll up
            your sleeves, grab your favorite fork, and let's get cooking—tonight's meal is about to
            be a hit!
          </p>
          <hr className="my-6" />
