      ...
      {randopes.recipes && (
        <>
          <p>
            ...
            weeknight dinners to delightful desserts, you’ll find inspiration for every craving. So,
            grab a fork, check out our delicious recipes, and make a meal tonight! So roll up your
            sleeves, grab your favorite fork, and let&apos;s get cooking—tonight&apos;s meal is
            about to be a hit!
          </p>
          <hr className="my-6" />
