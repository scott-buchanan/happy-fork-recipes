...
export default function Home() {
  ...
  return (
    <PageTemplate>
            ...
            weeknight dinners to delightful desserts, you&apos;ll find inspiration for every
            craving. So, grab a fork, check out our delicious recipes, and make a meal tonight!
          </p>
