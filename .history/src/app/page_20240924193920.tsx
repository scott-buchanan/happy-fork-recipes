  ...
  return (
    <PageTemplate>
      <p className="mb-8 mt-5 text-xl">
        ...
        delicious? At Happy Fork Recipes, we&apos;ve got your back. From <b>comforting classics</b>{' '}
        to <b>fresh new favorites</b> or from quick weeknight dinners to delightful desserts,
        we&apos;re here to help you whip up something amazing. You&apos;ll find inspiration for
        every craving! So, grab a fork, check out our delicious recipes, and make a meal tonight!
      </p>
