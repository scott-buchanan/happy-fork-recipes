      ...
      {recipeData && (
        <>
          <div className="flex items-start gap-5">
            <div>
              <div className="mb-5 flex rounded-xl border border-gray-300 bg-white">
              ...
              <article className="mb-3 flex-grow rounded-full border border-gray-300 bg-white p-3">
                <h2>Instructions</h2>
            ...
            <aside className="w-1/2 rounded-lg border border-gray-300 bg-white p-3">
              <h2>Ingredients</h2>
              <ul>
