        ...
        <>
          <div className="flex items-start gap-16 p-5">
            <article className="mb-3 flex-grow">
              ...
              <div className="mx-auto flex p-5 text-center">
                <div className="border-x border-gray-400 p-5">
                  Ready in: {recipeData.readyInMinutes} minutes
                </div>
                <div className="border-r border-gray-400 p-5">Serves: {recipeData.servings}</div>
              </div>
