        ...
        <div className="flex items-start gap-16 p-5">
          ...
          <aside className="w-1/2 min-w-96 overflow-hidden rounded-3xl border border-gray-300 bg-white">
            <Img
              ...
              height={500}
            >
              <div className="flex w-full justify-between bg-black/50 px-20 py-3 text-3xl text-white">
                <div className="flex items-center">
                  <Icon icon="ph:fork-knife-duotone" className="text-3xl" />{' '}
                  {recipeData.readyInMinutes}
                </div>
                <div className="flex items-center">
                  <Icon icon="ph:fork-knife-duotone" className="text-3xl" /> {recipeData.servings}
                </div>
              </div>
            </Img>
            <div className="p-5">
