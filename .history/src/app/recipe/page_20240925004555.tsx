    ...
    <PageTemplate>
      ...
      {recipeData && (
        <div className="flex items-start gap-16 p-5">
          ...
          <aside className="min-w-[1/3] overflow-hidden rounded-3xl border border-gray-300 bg-white">
            <Img
            ...
            >
              <div className="columns-2 bg-black/50 px-5 py-3 text-white">
                <div className="flex items-center">
                  ...
                  <span className="text-sm">Ready in {recipeData.readyInMinutes} minutes</span>
                </div>
                <div className="flex items-center">
